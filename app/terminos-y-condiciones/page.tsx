    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#fff', minHeight: '100vh', color: '#111827' }}><style>{`
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 20px 80px', display: 'grid', gridTemplateColumns: '220px 1fr', gap: 48, alignItems: 'start' }}>
        ...
        <main>
          ...
          {/* 1 */}
          <div id="responsable" className="section-block"><h2 className="legal-h2">1. Responsable del servicio</h2><p className="legal-p">
              ...
              Contacto: <a href="mailto:hola@salurama.com" style={{ color: '#1E3A5F' }}>hola@salurama.com</a> · Para asuntos de privacidad: <a href="mailto:privacidad@salurama.com" style={{ color: '#1E3A5F' }}>privacidad@salurama.com</a></p><p className="legal-p">
          ...
          {/* 2 */}
          <div id="naturaleza" className="section-block"><h2 className="legal-h2">2. Naturaleza del servicio</h2><p className="legal-p">
            ...
            </p><div className="alert-box"><p>Salurama NO presta servicios médicos, NO realiza diagnósticos, NO recomienda tratamientos, NO garantiza resultados médicos, NO interviene en la relación médico-paciente y NO procesa pagos entre pacientes y profesionales.</p></div><p className="legal-p">
          ...
          {/* 3 */}
          <div id="verificacion" className="section-block"><h2 className="legal-h2">3. Verificación de credenciales</h2><p className="legal-p">
            ...
            </p><ul className="legal-ul"><li className="legal-li">Enlace al portal de la Dirección General de Profesiones de la Secretaría de Educación Pública (SEP) para consulta de cédulas profesionales.</li><li className="legal-li">Enlace al consejo o colegio de la especialidad correspondiente para consulta de certificaciones vigentes.</li></ul><div className="warning-box"><p>⚠️ Salurama NO verifica, avala, certifica ni garantiza la autenticidad o vigencia de ninguna credencial. Los datos mostrados en los perfiles son proporcionados por los propios profesionales. La verificación la realiza el usuario directamente en las fuentes oficiales indicadas. Salurama actúa como facilitador de información, no como autoridad certificadora.</p></div><p className="legal-p">
          ...
          {/* 4 */}
          <div id="limitacion" className="section-block"><h2 className="legal-h2">4. Limitación de responsabilidad</h2><p className="legal-p">Salurama no será responsable por:</p><ul className="legal-ul"><li className="legal-li">Actos u omisiones de los profesionales de la salud registrados en la plataforma.</li><li className="legal-li">Resultados de tratamientos, diagnósticos o intervenciones médicas.</li><li className="legal-li">Información falsa, inexacta o desactualizada proporcionada por los profesionales.</li><li className="legal-li">Daños derivados del uso o imposibilidad de uso de la plataforma.</li><li className="legal-li">Comunicaciones, acuerdos o transacciones realizadas fuera de la plataforma.</li><li className="legal-li">Interrupciones del servicio por causas de fuerza mayor o problemas técnicos ajenos a Salurama.</li></ul><p className="legal-p"><strong className="legal-strong">Límite de responsabilidad contractual:</strong> En ningún caso la responsabilidad acumulada de SALURAMA S.A.S. por cualquier concepto derivado del uso de la plataforma excederá la cantidad de <strong className="legal-strong">$1,000.00 MXN (un mil pesos 00/100 M.N.)</strong>. Este límite no aplica en casos de dolo o mala fe comprobada de Salurama.
            </p></div>
          ...
          {/* 6 */}
          <div id="contenido" className="section-block"><h2 className="legal-h2">6. Contenido generado por usuarios</h2><h3 className="legal-h3">Reseñas y calificaciones</h3><p className="legal-p">
            ...
            </p><h3 className="legal-h3">Moderación</h3><p className="legal-p">
          ...
          {/* 7 */}
          <div id="propiedad" className="section-block"><h2 className="legal-h2">7. Propiedad intelectual</h2><p className="legal-p">
          ...
          {/* 8 */}
          <div id="monetizacion" className="section-block"><h2 className="legal-h2">8. Modelo de negocio y publicidad</h2><p className="legal-p">
            ...
            </p><div className="alert-box"><p>Los acuerdos comerciales con terceros no afectan el orden de aparición de los profesionales en los resultados de búsqueda. Ningún médico puede pagar para aparecer primero. El orden refleja relevancia para la búsqueda del usuario, no inversión publicitaria.</p></div><p className="legal-p">
          ...
          {/* 9 */}
          <div id="modificaciones" className="section-block"><h2 className="legal-h2">9. Modificaciones a estos Términos</h2><p className="legal-p">
          ...
          {/* 10 */}
          <div id="jurisdiccion" className="section-block"><h2 className="legal-h2">10. Jurisdicción y ley aplicable</h2><p className="legal-p">
