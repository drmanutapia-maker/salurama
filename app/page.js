      ...
      <section style={{ padding: '80px 24px 60px', textAlign: 'center' }}>
        <div style={{ maxWidth: 680, margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: 12 }}>
            <span style={{ fontFamily: "'Fraunces', serif", fontSize: 'clamp(48px, 8vw, 72px)', fontWeight: 900, color: '#0D5C4A', letterSpacing: '-1px' }}>Salu</span>
            <span style={{ fontFamily: "'Fraunces', serif", fontSize: 'clamp(48px, 8vw, 72px)', fontWeight: 600, color: '#F59E0B', letterSpacing: '-1px' }}>rama</span>
          </div>
