          ...
          <div>
            ...
            {(tieneRedes || true) && (
              <div style={{ display: 'flex', gap: 10, marginBottom: 16, alignItems: 'center' }}>
                ...
                {medico.website_url && (
                  <a href={medico.website_url} target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: '50%', background: '#1E3A5F', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', flexShrink: 0 }} title="Página web">
                    <Globe size={16} />
                  </a>
                )}
                <button
