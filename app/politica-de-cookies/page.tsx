  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#fff', minHeight: '100vh', color: '#111827' }}><style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        .nav-link { color: #111827; text-decoration: none; font-size: 15px; font-weight: 400; padding: 6px 2px; border-bottom: 2px solid transparent; transition: color 0.15s, border-color 0.15s; }
        .nav-link:hover { color: #1E3A5F; border-color: #1E3A5F; }
        .btn-medico { background: #1E3A5F; color: #fff; text-decoration: none; padding: 10px 20px; border-radius: 50px; font-size: 14px; font-weight: 600; font-family: 'DM Sans', sans-serif; transition: background 0.18s; display: inline-flex; align-items: center; gap: 7px; }
        ...
        .cookie-table th { background: #0D1829; color: #fff; padding: 10px 14px; text-align: left; font-weight: 600; }
        .cookie-table td { padding: 9px 14px; color: #4A5568; border-bottom: 1px solid #F3F4F6; vertical-align: top; }
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(160deg, #E8ECF3 0%, #fff 60%)', padding: 'clamp(40px,6vw,60px) 20px 32px' }}><div style={{ maxWidth: 860, margin: '0 auto' }}><p style={{ fontSize: 11, fontWeight: 600, color: '#2A9D8F', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 10 }}>Tecnología y privacidad</p><h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 'clamp(28px,6vw,40px)', fontWeight: 900, color: '#0D1829', marginBottom: 12 }}>
            Política de Cookies
          </h1><p style={{ fontSize: 14, color: '#6B7280' }}>Última actualización: 31 de marzo de 2026 · SALURAMA S.A.S.</p></div></section>

      {/* CONTENIDO */}
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '40px 20px 80px' }}><div className="section-block"><h2 className="legal-h2">1. ¿Qué son las cookies?</h2><p className="legal-p">
            ...
            El uso de cookies en salurama.com está regulado por la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (vigente desde el 21 de marzo de 2025) y los presentes Términos.
          </p></div><div className="section-block"><h2 className="legal-h2">2. Cookies que utilizamos</h2><h3 className="legal-h3">Cookies necesarias <span className="badge badge-green">No requieren consentimiento</span></h3><p className="legal-p">Son indispensables para el funcionamiento básico de la plataforma. No pueden desactivarse sin afectar el servicio.</p><table className="cookie-table"><thead><tr><th>Cookie</th><th>Finalidad</th><th>Duración</th></tr></thead><tbody>{[
              ...
              ].map(([n,f,d]) =><tr key={n}><td><code>{n}</code></td><td>{f}</td><td>{d}</td></tr>)}</tbody></table><h3 className="legal-h3" style={{ marginTop: 28 }}>Cookies de análisis <span className="badge badge-yellow">Requieren consentimiento</span></h3><p className="legal-p">Nos permiten entender cómo los usuarios interactúan con la plataforma para mejorarla. Los datos se procesan de forma agregada y anónima.</p><table className="cookie-table"><thead><tr><th>Proveedor</th><th>Finalidad</th><th>Duración</th><th>Política</th></tr></thead><tbody><tr><td>Vercel Analytics</td><td>Estadísticas de uso y rendimiento</td><td>90 días</td><td><a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#1E3A5F' }}>ver política</a></td></tr></tbody></table><h3 className="legal-h3" style={{ marginTop: 28 }}>Cookies de funcionalidad <span className="badge badge-yellow">Requieren consentimiento</span></h3><p className="legal-p">Permiten recordar preferencias del usuario entre sesiones.</p><table className="cookie-table"><thead><tr><th>Cookie</th><th>Finalidad</th><th>Duración</th></tr></thead><tbody>{[
          ...
          </p></div><div className="section-block"><h2 className="legal-h2">4. Gestión del consentimiento</h2><p className="legal-p">
            Al acceder por primera vez a salurama.com, verá un banner que le permitirá:
          </p><ul className="legal-ul"><li className="legal-li"><strong className="legal-strong">Aceptar todas</strong> las cookies (necesarias + análisis + funcionalidad).</li><li className="legal-li"><strong className="legal-strong">Rechazar</strong> las cookies no necesarias (solo se activarán las técnicas).</li><li className="legal-li"><strong className="legal-strong">Configurar</strong> sus preferencias por categoría.</li></ul><p className="legal-p">Su elección se guarda en la cookie <code>cookie-consent</code> por 12 meses. Puede modificar sus preferencias en cualquier momento desde el enlace "Configurar cookies" en el pie de página.</p><div className="alert-box"><p>Las cookies necesarias no pueden desactivarse. Son imprescindibles para mantener su sesión activa y garantizar la seguridad de la plataforma.</p></div></div><div className="section-block"><h2 className="legal-h2">5. Cómo gestionar cookies en su navegador</h2><p className="legal-p">También puede gestionar o eliminar cookies directamente desde su navegador:</p><ul className="legal-ul"><li className="legal-li"><strong>Chrome:</strong> Configuración → Privacidad y seguridad → Cookies y otros datos de sitios.</li><li className="legal-li"><strong>Firefox:</strong> Opciones → Privacidad y seguridad → Cookies y datos del sitio.</li><li className="legal-li"><strong>Safari:</strong> Preferencias → Privacidad → Gestionar datos de sitios web.</li><li className="legal-li"><strong>Edge:</strong> Configuración → Privacidad, búsqueda y servicios → Cookies.</li></ul><p className="legal-p">
          ...
          </p></div><div className="section-block"><h2 className="legal-h2">6. Actualizaciones</h2><p className="legal-p">
