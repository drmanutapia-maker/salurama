    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#fff', minHeight: '100vh', color: '#111827' }}><style>{`
      ...
      <div className="legal-grid" style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 20px 80px', display: 'grid', gridTemplateColumns: '220px 1fr', gap: 48, alignItems: 'start' }}>
        ...
        <main>
          ...
          {/* 2 */}
          <div id="datos" className="section-block"><h2 className="legal-h2">2. Datos personales que recabamos</h2><h3 className="legal-h3">De usuarios (pacientes)</h3><ul className="legal-ul"><li className="legal-li">Nombre completo y correo electrónico (al registrarse).</li><li className="legal-li">Teléfono y ciudad (opcionales, si el usuario los proporciona).</li><li className="legal-li">Historial de búsquedas en la plataforma.</li><li className="legal-li">Dirección IP y datos de navegación (cookies técnicas).</li><li className="legal-li">Identificador de suscripción a notificaciones push (endpoint y llaves de cifrado del navegador), únicamente si activa esta función.</li><li className="legal-li">Contenido de los mensajes que envíe por el chat cifrado con su médico, cuando exista una cita registrada en la plataforma.</li></ul><h3 className="legal-h3">De profesionales de la salud</h3><ul className="legal-ul"><li className="legal-li">Nombre completo y datos de contacto profesional.</li><li className="legal-li">Número de cédula profesional (dato público, proporcionado voluntariamente para su perfil).</li><li className="legal-li">Consejo de especialidad (para enlace de consulta pública).</li><li className="legal-li">Ciudad, estado y dirección del consultorio (opcionales).</li><li className="legal-li">Fotografía de perfil, descripción y costo de consulta (opcionales).</li><li className="legal-li">Llave pública y metadatos de dispositivo (nombre del dispositivo, fecha del último uso) al registrar un acceso biométrico (passkey/WebAuthn). La huella dactilar, el reconocimiento facial o el PIN nunca se transmiten ni se almacenan en nuestros servidores — permanecen exclusivamente en el dispositivo del profesional.</li><li className="legal-li">Identificador de suscripción a notificaciones push (endpoint y llaves de cifrado del navegador), únicamente si activa esta función.</li><li className="legal-li">Contenido de los mensajes del chat cifrado con sus pacientes.</li></ul><div className="alert-box"><p>IMPORTANTE: La cédula profesional y datos de especialidad son información pública disponible en portales gubernamentales. Su inclusión en Salurama tiene como único propósito que los pacientes puedan acceder fácilmente a las fuentes oficiales de verificación (SEP, consejos de especialidad). Salurama NO verifica ni certifica estas credenciales.</p></div><h3 className="legal-h3">Datos que NO recabamos</h3><p className="legal-p">
              Salurama <strong className="legal-strong">no recaba</strong> información clínica de pacientes, diagnósticos, historial médico personal, ni información financiera completa. Tampoco solicitamos ni almacenamos datos biométricos en nuestros servidores: en el acceso mediante passkey/WebAuthn, la huella o reconocimiento facial nunca sale del dispositivo del usuario. No recabamos datos personales de menores de 18 años.
            </p></div>

          {/* 3 */}
          <div id="finalidades" className="section-block"><h2 className="legal-h2">3. Finalidades del tratamiento</h2><h3 className="legal-h3">Finalidades primarias (necesarias para el servicio)</h3><ul className="legal-ul"><li className="legal-li">Crear y administrar cuentas de usuario en la plataforma.</li><li className="legal-li">Mostrar perfiles públicos de profesionales de la salud.</li><li className="legal-li">Facilitar la conexión entre pacientes y profesionales.</li><li className="legal-li">Operación, mantenimiento y mejora técnica de la plataforma.</li><li className="legal-li">Atender solicitudes de derechos ARCO y otras comunicaciones.</li><li className="legal-li">Enviar notificaciones push a los dispositivos que el usuario autorice expresamente (citas, mensajes de chat, reseñas).</li></ul><h3 className="legal-h3">Finalidades secundarias (requieren consentimiento expreso)</h3><ul className="legal-ul"><li className="legal-li">Envío de comunicaciones sobre nuevas funcionalidades o servicios de Salurama.</li><li className="legal-li">Elaboración de estadísticas y análisis de uso (siempre en forma agregada y anónima).</li><li className="legal-li">Compartir información con socios comerciales del sector salud para contenido educativo o informativo relevante.</li></ul><p className="legal-p">
