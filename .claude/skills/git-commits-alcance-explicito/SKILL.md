...
final del comando, después de `--`. Esto commitea solo esos archivos
(estén o no ya en stage) y deja todo lo demás intacto en el índice y en
el working tree, sin necesidad de hacer `git add` por separado primero.
